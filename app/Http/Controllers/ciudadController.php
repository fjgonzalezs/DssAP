...
$repetidos = array();
 ...
 //return var_dump($abanderado);
      ...
      public function primerescolta()
    {
        ...
        $comprobar = DB::table('estudiantes')
        ->select('idElegido')
        ->where('idElegido','Primer escolta del estandarte de la ciudad')
        ->first();
...
$repetidos = array();
 ...
 if(count($repetidos)>0){
   ...
   //$empatados = $this->dssciudad($abanderado->idEstudiante,$repetidos,$abanderado->totalNota);
   return view('ciudad.primerescolta',compact('empatados','notaRepetida'));
   //return $estudiante->totalNota;
   //return var_dump($empatados);
 ...
 ->join('notas','estudiantes.idNota','=','notas.idNota') //creo que no es necesario el join
 ->where('idEstudiante',$ids[0])
 ->update(['idElegido' => 'Primer escolta del estandarte de la ciudad']);
 
    return "elegido Primer escolta del estandarte de la ciudad ";
 ...
 //return var_dump($abanderado);
    ...
    public function dssprimerescolta(Request $request){
       ...
       if(count($contador) ==1){
        ...
        return "Primer escolta del estandarte de la ciudad elegido";
      ...
      public function segundoescolta()
    {
        ...
        $comprobar = DB::table('estudiantes')
        ->select('idElegido')
        ->where('idElegido','Segundo escolta del estandarte de la ciudad')
        ->first();
...
$repetidos = array();
 ...
 if(count($repetidos)>0){
   ...
   //$empatados = $this->dssciudad($abanderado->idEstudiante,$repetidos,$abanderado->totalNota);
   return view('ciudad.segundoescolta',compact('empatados','notaRepetida'));
   //return $estudiante->totalNota;
   //return var_dump($empatados);
 ...
 ->join('notas','estudiantes.idNota','=','notas.idNota') //creo que no es necesario el join
 ->where('idEstudiante',$ids[0])
 ->update(['idElegido' => 'Segundo escolta del estandarte de la ciudad']);
 
    return "elegido Segundo escolta del estandarte de la ciudad ";
 ...
 //return var_dump($abanderado);
    ...
    public function dsssegundoescolta(Request $request){
       ...
       if(count($contador) ==1){
        ...
        return "Segundo escolta del estandarte de la ciudad elegido";
